...
class FakeMessageFactory {
    ...
    class func createTextMessageModel(uid: String, isIncoming: Bool) -> TextMessageModel {
        ...
        return WhatchaIphone.createTextMessageModel(uid, text: text, isIncoming: isIncoming)
    }
    ...
    class func createPhotoMessageModel(uid: String, isIncoming: Bool) -> PhotoMessageModel {
        ...
        return WhatchaIphone.createPhotoMessageModel(uid, image: UIImage(named: imageName)!, size: imageSize, isIncoming: isIncoming)
    }
}
